  ...
  <div class="p-layout">
    ...
    <div class="p-layout-topbar clearfix">
      <div class="p-layout-name" :class="{'sider-mini': isCollapse}">
        <a href="javascript:;" class="full" v-if="!isCollapse">Admin</a>
        <span class="mini" v-else>A</span>
      </div>
      <div class="p-layout-collapse" @click="toggleSider"><i class="el-icon-menu"></i></div>
      <div class="p-layout-nav">
        <el-dropdown class="is-user" @command="handleDropdown">
          <img src="../../assets/logo.png" class="p-layout-avatar" alt="">
    ...
    <div
      ...
      <aside class="p-layout-sider">
        <div class="p-layout-user">
          <img alt="" src="../../assets/logo.png" class="p-layout-avatar">
          <div>alsy</div>
        </div>
        <el-menu
          theme="dark"
          ...
          <el-submenu
            ...
            <el-menu-item
              :index="subMenu.path"
              v-for="(subMenu, subIndex) in menu.children" :key="menu.name">
